...
% Se escogen las medidas reales con ruido y muestreadas
clear all;
...
% theta_err=[1,  0.025143665463728,    -5.9862;
%            2,  0.000005436552851,     2.1984;
%            3,  0.081299020277041,     4.0684;
%            4,  0.841650362316433,     3.8348;
%            5,  0.041912895110567,     7.7617;
%            6,  0.000008692987532,    15.7319;
%            7,  0.006693026242915,    15.5411;
%            8,  0.475275653184315,    14.4064;
%            9,  0.001313979835617,    13.1662;
%           10,  0.000093518420424,    13.8915;
%           11,  0.000060046467256,     3.2593];

      
%Como el resultado de la estimacion para los parametros 3 y 7 es muy distinto de el ideal, añadimos un 15%
%de error a los ideales
