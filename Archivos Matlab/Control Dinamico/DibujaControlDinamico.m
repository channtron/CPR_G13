...
%Intensidades
figure();subplot(3,1,1);plot(ts,Ims(:,1));grid;xlabel('Tiempo(s)');ylabel('Im1(A)');...
    subplot(3,1,2);plot(ts,Ims(:,2));grid;xlabel('Tiempo(s)');ylabel('Im2(A)');...
    subplot(3,1,3);plot(ts,Ims(:,3));grid;xlabel('Tiempo(s)');ylabel('Im3(A)');
